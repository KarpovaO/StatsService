...
class StatsServiceTest {
    ...
    @Test
    void shouldMinSalesMonths() {
        StatsService service = new StatsService();
        int[] purchases = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;

        int actual = service.calculateMinSalesMonths(purchases);
        assertEquals(expected, actual);
    }

    @Test
    void shouldMaxSalesMonths() {
        StatsService service = new StatsService();
        int[] purchases = {8, 15, 13, 15, 17, 20, 19, 20, 7, 14, 14, 18};
        int expected = 5;

        int actual = service.calculateMaxSalesMonths(purchases);
        assertEquals(expected, actual);
    }
}
